...
{ 
	...
	void Start () 
	{
		...
		Transform[] aBones = new Transform[meshFilters.Count];
		Matrix4x4[] bindPoses = new Matrix4x4[meshFilters.Count];
	...
	public void AddMeshFilterToMerge(MeshFilter filter)
	{
